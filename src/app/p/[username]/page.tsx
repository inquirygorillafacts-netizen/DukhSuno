...
import { Phone, Star, ChevronDown, ShieldCheck, Zap, Sparkles, AlertCircle, Wallet, X, ArrowRight, TrendingUp, ChevronLeft, MessageCircle, Check, Clock } from 'lucide-react';
export default function ProfessionalProfilePage() {
        ...
        async function initListener() {
            try {
                ...
                if (!snap.empty) {
                    ...
                    // Attach real-time listener on the found document
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-700 slide-in-from-bottom-2 pb-32">
            ...
            {/* Profile Hero — Same as /seeker/listener */}
