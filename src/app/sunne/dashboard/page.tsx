        ...
        <div className="flex flex-col gap-8 relative z-10">
          ...
          <div className="space-y-4 py-2">
            <div className="flex items-center gap-2 px-2">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.4em] text-slate-400">Profile Referral Link</span>
            </div>
            <div className="p-1 rounded-2xl bg-slate-50/50 border border-slate-100 flex items-center justify-between group">
              ...
              <button
                ...
                className={`h-10 px-4 rounded-xl flex items-center gap-2 transition-all active:scale-95 ${copied ? 'bg-emerald-500 text-white' : 'bg-slate-900 text-white'}`}
              >
