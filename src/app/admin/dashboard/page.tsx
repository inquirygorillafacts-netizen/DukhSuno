...
import { Sparkles, Globe, Settings as SettingsIcon } from "lucide-react";
                    ...
                    <div className="bg-slate-900 rounded-[2.4rem] p-6 md:p-8 relative overflow-hidden">
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="space-y-4 text-center md:text-left">
                                ...
                                <h2 className="text-2xl font-black text-white tracking-tight">Ecosystem Health: <span className="text-amber-400">Excellent</span></h2>
                                <p className="text-white/60 text-[11px] font-medium max-w-sm">All systems nominal. Twilio capacity at 100%. Latency: 12ms.</p>
                            </div>
                            <div className="flex gap-3">
                                ...
                                <div className="px-5 py-3 rounded-2xl bg-white/5 border border-white/10 flex flex-col items-center justify-center space-y-1 group hover:bg-white/10 transition-all cursor-pointer min-w-[100px]">
                                    ...
                                    <p className="text-[9px] font-black text-white uppercase tracking-widest">System Log</p>
                                </div>
                            </div>
                        </div>
                    </div>
