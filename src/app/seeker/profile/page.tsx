    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-700 slide-in-from-bottom-2 pb-24">
      ...
      {!user?.roles?.includes('provider') && (
        <button 
           ...
           className="w-full p-6 md:p-10 rounded-3xl bg-gradient-to-br from-indigo-50 to-indigo-100/50 border border-indigo-100 flex items-center justify-between group shadow-sm hover:shadow-xl transition-all"
        >
