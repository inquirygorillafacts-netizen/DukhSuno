...
export function IncomingCallBanner() {
  ...
  return (
    <div className="fixed top-6 left-6 right-6 z-[9999] animate-slide-down max-w-lg mx-auto">
      ...
      <div className="glass-container bg-white/90 dark:bg-slate-900/90 border-emerald-500/30 rounded-[2.5rem] p-6 shadow-2xl flex items-center gap-5 backdrop-blur-3xl overflow-hidden relative">
        ...
        <div className="flex-1">
          ...
          <p className="text-[20px] font-black text-slate-900 dark:text-white tracking-tighter leading-none mb-1 uppercase italic">
