...
export default function ListenerSidebar() {
    ...
    const links = [
        { name: "My Dashboard", href: "/sunne/dashboard", icon: LayoutDashboard },
        { name: "Go Live", href: "/sunne/live", icon: Radio, highlight: true },
        { name: "Call History", href: "/sunne/calls", icon: History },
        { name: "My Earnings", href: "/sunne/earnings", icon: Wallet },
        { name: "My Profile", href: "/sunne/profile", icon: User },
        { name: "Settings", href: "/sunne/settings", icon: Settings },
    ];
                        ...
                        return (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    isActive ? "bg-emerald-50 text-emerald-600 shadow-sm" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900",
